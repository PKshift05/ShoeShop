...
import { fetchProductsSearch } from '../../redux-toolkit/action/productAction';
import { selectProductSearch } from '../../redux-toolkit/slice/productSlice';
...
const SearchResult = () => {
  ...
  const searchData = useSelector(selectProductSearch)
  ...
  const getProductsSearch = async () => {
    dispatch(fetchProductsSearch({name: queryValue})) 
  }
